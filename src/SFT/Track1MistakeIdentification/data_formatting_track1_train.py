...
"""
DEFINITION = "Has the tutor explicitly pointed out that there was a mistake in a student's response?"
RUBRIC = """
...
def main():
    ...
    path_output = os.path.join(path_base, "src", "SFT", "LLaMA-Factory", "data", "mrbench_v3_devset_train_track1.json")
    # 读取数据文件
