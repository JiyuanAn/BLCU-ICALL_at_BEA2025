    ...
    for index in range(len(data)):
        ...
        for model in item['tutor_responses']:
            ...
            for dimension in item['tutor_responses'][model]['annotation_pred']:
                ...
                label = -1
                if 'Classification:' in item['tutor_responses'][model]['annotation_pred'][dimension]['response']:
                    text = item['tutor_responses'][model]['annotation_pred'][dimension]['response'].split('Classification:')[1].strip()
                    print(text)
